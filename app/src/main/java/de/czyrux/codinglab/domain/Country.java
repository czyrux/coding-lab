...
public class Country implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeStringArray(alternativeSpellings);
        dest.writeFloat(relevance);
        ...
        dest.writeStringArray(timezones);
        dest.writeStringArray(borders);
        dest.writeString(nativeName);
        dest.writeStringArray(callingCodes);
        dest.writeStringArray(topLevelDomain);
        dest.writeString(alpha2Code);
        dest.writeString(alpha3Code);
        dest.writeStringArray(currencies);
    ...
    private void readFromParcel(Parcel in) {
        ...
        alternativeSpellings = in.createStringArray();
        relevance = in.readFloat();
